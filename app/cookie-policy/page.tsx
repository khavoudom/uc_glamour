...
export default function CookiePolicyPage() {
  return (
    <ContentPageLayout title="Cookie Policy">
      ...
      <h2 className="font-heading text-[18px] text-text font-normal mt-6">What Are Cookies</h2>
      <p>
        Cookies are small text files stored on your device when you visit a website. They help the
        site remember your preferences and improve your browsing experience.
      </p>

      <h2 className="font-heading text-[18px] text-text font-normal mt-6">How We Use Cookies</h2>
      <p>
      ...
      <h2 className="font-heading text-[18px] text-text font-normal mt-6">Managing Cookies</h2>
      <p>
