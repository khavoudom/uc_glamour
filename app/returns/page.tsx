...
export default function ReturnsPage() {
  return (
    <ContentPageLayout title="Returns">
      ...
      <h2 className="font-heading text-[18px] text-text font-normal mt-6">Return Policy</h2>
      <p>
      ...
      <h2 className="font-heading text-[18px] text-text font-normal mt-6">How to Return</h2>
      ...
      <h2 className="font-heading text-[18px] text-text font-normal mt-6">Refund Timeline</h2>
      <p>
