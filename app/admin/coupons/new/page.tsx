...
import { createCouponAction, type CouponFormState } from '@/app/actions/admin/coupons';
...
export default function NewCouponPage() {
  ...
  return (
    <div>
      <h1 className="font-heading mb-6 text-2xl font-medium text-text">New Coupon</h1>
