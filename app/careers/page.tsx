...
export default function CareersPage() {
  return (
    <ContentPageLayout title="Careers">
      ...
      <h2 className="font-heading text-lg text-text font-normal mt-6">Why Work With Us</h2>
      <p>
      ...
      <h2 className="font-heading text-lg text-text font-normal mt-6">Open Positions</h2>
