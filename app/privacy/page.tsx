...
export default function PrivacyPage() {
  return (
    <ContentPageLayout title="Privacy Policy">
      ...
      <h2 className="font-heading text-[18px] text-text font-normal mt-6">Data Protection</h2>
      <p>
      ...
      <h2 className="font-heading text-[18px] text-text font-normal mt-6">Your Rights</h2>
      <p>
      ...
      <h2 className="font-heading text-[18px] text-text font-normal mt-6">Contact</h2>
