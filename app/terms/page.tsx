...
export default function TermsPage() {
  return (
    <ContentPageLayout title="Terms of Service">
      ...
      <h2 className="font-heading text-lg text-text font-normal mt-6">Use of Our Service</h2>
      <p>
      ...
      <h2 className="font-heading text-lg text-text font-normal mt-6">Orders &amp; Payments</h2>
      <p>
      ...
      <h2 className="font-heading text-lg text-text font-normal mt-6">Intellectual Property</h2>
      <p>
      ...
      <h2 className="font-heading text-lg text-text font-normal mt-6">Limitation of Liability</h2>
      <p>
